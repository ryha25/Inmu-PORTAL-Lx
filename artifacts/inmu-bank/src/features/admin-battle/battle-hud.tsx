import { Pause, Play, Shield, Sparkles, Swords, X } from 'lucide-react'
import type { BattleSnapshot } from './types'

export function BattleHud({ snapshot, onPause, onAbort }: { snapshot: BattleSnapshot; onPause: () => void; onAbort: () => void }) {
