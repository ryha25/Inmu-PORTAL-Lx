...
import daifugoImage from '@assets/inmu-pet-daifugo-v5.png'
import daifugoAngryImage from '@assets/inmu-pet-daifugo-angry-v5.png'
import daifugoAnnoyedImage from '@assets/inmu-pet-daifugo-annoyed-v5.png'
import daifugoBlinkImage from '@assets/inmu-pet-daifugo-blink-v5.png'
import daifugoHappyImage from '@assets/inmu-pet-daifugo-happy-v5.png'
import daifugoHungryImage from '@assets/inmu-pet-daifugo-hungry-v5.png'
import daifugoPettedImage from '@assets/inmu-pet-daifugo-petted-v5.png'
import daifugoSleepImage from '@assets/inmu-pet-daifugo-sleep-v5.png'
import daifugoSleepyImage from '@assets/inmu-pet-daifugo-sleepy-v5.png'
import daifugoWalk1Image from '@assets/inmu-pet-daifugo-walk-1-v2.png'
import daifugoWalk2Image from '@assets/inmu-pet-daifugo-walk-2-v2.png'
...
const YAJUSENPAI_PET_DEFINITIONS: readonly PetDefinition[] = UPCOMING_PET_DEFINITIONS.map(source => {
  ...
  const roomPresentation = {
    ...
    'yajusenpai-male-evolved': { width: 'clamp(360px, 88%, 510px)', offsetY: '0%' },
    'yajusenpai-female-base': { width: 'clamp(355px, 80%, 440px)', offsetY: '11%' },
    'yajusenpai-female-evolved': { width: 'clamp(380px, 92%, 530px)', offsetY: '0%' },
  }[source.id]
  return {
    id: source.id,
    name: source.name,
...
export const PET_DEFINITIONS: readonly PetDefinition[] = [
  ...
  },
  {
    ...
    skill: {
      ...
      notes: ['Lv.1から発動', '1日3回まで発動', '発動時は結果画面に「もう一度引く」が表示されます'],
    },
    levelRewards: [
