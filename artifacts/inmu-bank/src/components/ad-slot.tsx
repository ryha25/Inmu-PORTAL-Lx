...
const NINJA_ADMAX_MOBILE_SRCS = [
  ...
  'https://adm.shinobi.jp/s/6cd0e4ffe955bdfc1614b58f1b5a2708',
  'https://adm.shinobi.jp/s/cbd96919f70bf449374b59b61d608105',
  'https://adm.shinobi.jp/s/366d20a9fe7efc805e8fcf01eb10faa1',
  'https://adm.shinobi.jp/s/afd4ff521183bec44f496e4a07119011',
  'https://adm.shinobi.jp/s/aeebb3d99b1d2a561e46ede2fbf94b8e',
  'https://adm.shinobi.jp/s/171b66f8d77b26c846aa21b91472c221',
  'https://adm.shinobi.jp/s/9c065465e5c987bb2dae847d7c456c87',
]
const NINJA_ADMAX_PC_RAIL_SRCS = [
  ...
  'https://adm.shinobi.jp/s/fac90483f7bb348048ab4a8aa6b265ff',
  'https://adm.shinobi.jp/s/a20021b788a7eff5797b9de23849c5ef',
  'https://adm.shinobi.jp/s/5301946fae1ea6b8c8708fbb678b9d9d',
]
...
<html>
  <head>
    ...
    <base target="_blank">
    <style>html,body{margin:0;padding:0;width:${width}px;height:${height}px;min-height:${height}px;overflow:visible;background:transparent;}body{display:flex;align-items:center;justify-content:center;}</style>
  </head>
  <body>
    <!-- admax -->
  ...
  return (
    <div className="relative overflow-hidden" style={{ width, height, minHeight: height }}>
      {!loaded && (
        <div className="absolute inset-0 flex items-center justify-center bg-card/45 text-[10px] font-semibold uppercase tracking-[0.18em] text-muted-foreground/55">
          AD
        </div>
      )}
      <iframe
